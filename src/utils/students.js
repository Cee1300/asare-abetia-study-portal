...
export const TIMETABLE = {
  ...
  ivan: [
    ...
    { day: 6,  date: '2026-05-26', subject: 'Science',     topic: 'Materials Around Us', standard: 'B3.5.2.1' },
    { day: 7,  date: '2026-05-27', subject: 'Mathematics', topic: 'Division: Sharing Equally', standard: 'B3.1.4.1' },
    { day: 8,  date: '2026-05-28', subject: 'English',     topic: 'Reading: Understanding a Short Story', standard: 'B3.3.2.1' },
    { day: 9,  date: '2026-05-29', subject: 'Mathematics', topic: 'Fractions: Halves, Quarters & Thirds', standard: 'B3.1.5.1' },
    { day: 10, date: '2026-05-30', subject: 'Science',     topic: 'Our Environment: Sun, Weather & Water', standard: 'B3.5.3.1' },
    { day: 11, date: '2026-05-31', subject: 'Mathematics', topic: 'Fractions: Halves, Quarters and Thirds', standard: 'B3.1.5.1' },
    { day: 12, date: '2026-06-01', subject: 'English',     topic: 'Writing: Sentences and Simple Paragraphs', standard: 'B3.3.3.1' },
    { day: 13, date: '2026-06-02', subject: 'Mathematics', topic: 'Measurement: Length, Weight and Capacity', standard: 'B3.4.1.1' },
    { day: 14, date: '2026-06-03', subject: 'English',     topic: 'Grammar: Nouns, Verbs and Adjectives', standard: 'B3.3.4.1' },
    { day: 15, date: '2026-06-04', subject: 'Mathematics', topic: 'Time: Reading the Clock and Using a Calendar', standard: 'B3.4.2.1' },
    { day: 16, date: '2026-06-05', subject: 'English',     topic: 'Creative Writing: Writing a Short Story', standard: 'B3.3.5.1' },
    { day: 17, date: '2026-06-06', subject: 'Mathematics', topic: 'Shapes: 2D and 3D Shapes Around Us', standard: 'B3.3.1.1' },
    { day: 18, date: '2026-06-07', subject: 'Science',     topic: 'Plants: Parts of a Plant and What They Do', standard: 'B3.5.4.1' },
    { day: 19, date: '2026-06-08', subject: 'Mathematics', topic: 'Money: Buying, Selling and Giving Change', standard: 'B3.1.6.1' },
    { day: 20, date: '2026-06-09', subject: 'English',     topic: 'Reading Comprehension: Understanding What You Read', standard: 'B3.3.6.1' },
  ],
}
