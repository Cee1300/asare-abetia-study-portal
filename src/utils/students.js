...
export const TIMETABLE = {
  ...
  declyn: [
    { day: 1,  date: '2026-04-29', subject: 'Mathematics', topic: 'Numbers to 1,000,000', standard: 'B5.1.1.1' },
    { day: 2,  date: '2026-04-30', subject: 'Science',     topic: 'Living Things: Classification', standard: 'B5.1.1.1' },
    { day: 3,  date: '2026-05-01', subject: 'Mathematics', topic: 'Multiply & Divide Large Numbers', standard: 'B5.1.2.1' },
    { day: 4,  date: '2026-05-03', subject: 'English',     topic: 'Oral Language & Communication', standard: 'B5.1.1.1' },
    { day: 5,  date: '2026-05-05', subject: 'Mathematics', topic: 'Fractions: Equivalence & Ordering', standard: 'B5.1.3.1' },
    { day: 6,  date: '2026-05-06', subject: 'Science',     topic: 'Materials & Mixtures', standard: 'B5.1.2.1' },
    { day: 7,  date: '2026-05-07', subject: 'Mathematics', topic: 'Fractions: All Four Operations', standard: 'B5.1.3.2' },
    { day: 8,  date: '2026-05-08', subject: 'English',     topic: 'Reading Comprehension', standard: 'B5.2.7.1' },
    { day: 9,  date: '2026-05-09', subject: 'Mathematics', topic: 'Decimals & Percentages', standard: 'B5.1.3.3' },
    { day: 10, date: '2026-05-10', subject: 'Science',     topic: 'Human Body: Digestive & Circulatory', standard: 'B5.3.1.1' },
  ],
  ivan: [
    { day: 1,  date: '2026-04-29', subject: 'Mathematics', topic: 'Place Value to 1,000', standard: 'B3.1.1.1' },
    { day: 2,  date: '2026-04-30', subject: 'Science',     topic: 'Living & Non-Living Things', standard: 'B3.1.1.1.1' },
    { day: 3,  date: '2026-05-01', subject: 'Mathematics', topic: 'Addition & Subtraction', standard: 'B3.1.2.1' },
    { day: 4,  date: '2026-05-03', subject: 'English',     topic: 'Stories, Songs & Conversation', standard: 'B3.1.1.1' },
    { day: 5,  date: '2026-05-05', subject: 'Mathematics', topic: 'Multiplication Tables', standard: 'B3.1.3.1' },
  ],
}
